...
const WaterRessources = () => {
    ...
    const article1 = '<p>Globally, about 4,000 billion cubic meters of freshwater are withdrawn each year to meet the needs of households, industries, and agriculture.</p>'
