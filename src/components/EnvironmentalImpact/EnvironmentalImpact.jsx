...
const EnvironmentalImpact = () => {
  ...
  const impactTopics = [
    ...
    { topic: 'Climate', image: fire, alt: 'forrest fire', details: '<article><p>Along with the other aspects discussed: Producing meat requires a lot of energy for things like running farms, processing plants, and transporting meat.</p><br><p>This energy often comes from burning fossil fuels, which releases carbon dioxide and other greenhouse gases that contribute to climate change.</p></article>' },
  ];
